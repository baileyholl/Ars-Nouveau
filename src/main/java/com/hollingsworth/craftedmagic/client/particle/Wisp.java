...
public class Wisp extends SpriteTexturedParticle {
    ...
    public Wisp(World world, double d, double d1, double d2, double xSpeed, double ySpeed, double zSpeed,
    ...
    public void renderParticle(BufferBuilder buffer, ActiveRenderInfo entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
        System.out.println("Rendering wisp");
    ...
    @Override
    public void tick() {
        System.out.println("Particle ticking");
    ...
    private static void beginRenderCommon(BufferBuilder bufferBuilder, TextureManager textureManager) {
        ...
        textureManager.bindTexture(vanillaParticles);
    ...
    private static final IParticleRenderType DIW_RENDER = new IParticleRenderType() {
        ...
        @Override
        public String toString() {
            return ArsNouveau.MODID + ":depth_ignoring_wisp";
        }
    };
}