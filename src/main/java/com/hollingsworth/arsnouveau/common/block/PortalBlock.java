...
public class PortalBlock extends ModBlock{
    ...
    public boolean trySpawnPortal(IWorld worldIn, BlockPos pos, BlockPos warpPos, int dimID) {
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
        ...
        return !flag && facingState.getBlock() != this && !(new PortalBlock.Size(worldIn, currentPos, direction$axis1)).func_208508_f() ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
    }
    ...
    public PortalBlock.Size isPortal(IWorld worldIn, BlockPos pos) {
        PortalBlock.Size portalblock$size = new PortalBlock.Size(worldIn, pos, Direction.Axis.X);
    ...
    public static BlockPattern.PatternHelper createPatternHelper(IWorld world, BlockPos pos) {
        ...
        PortalBlock.Size portalblock$size = new PortalBlock.Size(world, pos, Direction.Axis.X);
        ...
        if (!portalblock$size.isValid()) {
            ...
            portalblock$size = new PortalBlock.Size(world, pos, Direction.Axis.Z);
        }
    ...
    public static class Size {
        ...
        public void placePortalBlocks(BlockPos warpPos, int dimId) {
            for(int i = 0; i < this.width; ++i) {
