...
public class Present extends ModItem {
    ...
    @Override
    public void inventoryTick(@NotNull ItemStack pStack, @NotNull net.minecraft.server.level.ServerLevel pLevel, @NotNull Entity pEntity, net.minecraft.world.entity.@org.jetbrains.annotations.Nullable EquipmentSlot pSlot) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull Item.TooltipContext context, @NotNull TooltipDisplay display, @NotNull Consumer<Component> tooltip2, @NotNull TooltipFlag flagIn) {
        ...
        stack.addToTooltip(DataComponentRegistry.PRESENT.get(), context, display, tooltip2, flagIn);
    }
}
