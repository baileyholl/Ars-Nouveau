...
public class GlyphRecipeProvider extends SimpleDataProvider {
    ...
    public void collectJsons(CachedOutput pOutput) {
        ...
        add(get(AugmentExtendTime.INSTANCE).withItem(Items.CLOCK).withIngredient(Tags.Items.STORAGE_BLOCKS_REDSTONE, 1));
        ...
        add(get(EffectOrbit.INSTANCE).withItem(Items.COMPASS).withItem(Items.ENDER_EYE).withIngredient(Tags.Items.RODS_BLAZE, 1));
        add(get(MethodProjectile.INSTANCE).withItem(Items.FLETCHING_TABLE).withItem(Items.ARROW));
        add(get(MethodSelf.INSTANCE).withIngredient(ItemTags.WOODEN_PRESSURE_PLATES, 1).withItem(Items.IRON_CHESTPLATE));
        add(get(MethodTouch.INSTANCE).withIngredient(ItemTags.BUTTONS, 1));
        add(get(MethodUnderfoot.INSTANCE).withItem(Items.IRON_BOOTS).withIngredient(ItemTags.WOODEN_PRESSURE_PLATES, 1));

        add(get(EffectBlink.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withIngredient(Tags.Items.ENDER_PEARLS, 4));
        add(get(EffectBounce.INSTANCE).withItem(ItemsRegistry.ABJURATION_ESSENCE).withIngredient(Tags.Items.SLIME_BALLS, 3));
        ...
        add(get(EffectExchange.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.EMERALD_BLOCK).withIngredient(Tags.Items.ENDER_PEARLS, 2));
        ...
        add(get(EffectGlide.INSTANCE).withItem(ItemsRegistry.AIR_ESSENCE).withItem(Items.ELYTRA).withIngredient(Tags.Items.GEMS_DIAMOND, 3));
        add(get(EffectGravity.INSTANCE).withItem(ItemsRegistry.AIR_ESSENCE).withItem(Items.ANVIL, 2).withIngredient(Tags.Items.FEATHERS, 3));
        add(get(EffectGrow.INSTANCE).withItem(ItemsRegistry.EARTH_ESSENCE).withItem(Items.BONE_BLOCK, 5).withIngredient(Tags.Items.SEEDS, 3));
        ...
        add(get(EffectIntangible.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.PHANTOM_MEMBRANE, 3).withIngredient(Tags.Items.ENDER_PEARLS, 2));
        add(get(EffectInteract.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.LEVER).withIngredient(ItemTags.WOODEN_PRESSURE_PLATES, 1).withIngredient(ItemTags.BUTTONS, 1));
        add(get(EffectInvisibility.INSTANCE).withItem(ItemsRegistry.ABJURATION_ESSENCE).withItem(Items.FERMENTED_SPIDER_EYE).withIngredient(Tags.Items.RODS_BLAZE, 1));
        ...
        add(get(EffectLinger.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.DRAGON_BREATH)
                .withIngredient(Tags.Items.STORAGE_BLOCKS_DIAMOND, 1)
                .withIngredient(Tags.Items.RODS_BLAZE, 2));
        ...
        add(get(EffectWololo.INSTANCE).withItem(ItemsRegistry.ABJURATION_ESSENCE).withIngredient(Tags.Items.DYES, 3));
