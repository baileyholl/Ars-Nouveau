...
public class WorldgenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public static class BiomeModifierRegistry {
        ...
        public static void bootstrap(BootstrapContext<BiomeModifier> context) {
            ...
            context.register(STARBUNCLE_SPAWN, BiomeModifiers.AddSpawnsBiomeModifier.singleSpawn(OVERWORLD_TAG, new net.minecraft.util.random.Weighted<>(new MobSpawnSettings.SpawnerData(ModEntities.STARBUNCLE_TYPE.get(), 1, 2), 5)));

            context.register(GIFT_STARBUNCLE_SPAWN, BiomeModifiers.AddSpawnsBiomeModifier.singleSpawn(OVERWORLD_TAG, new net.minecraft.util.random.Weighted<>(new MobSpawnSettings.SpawnerData(ModEntities.GIFT_STARBY.get(), 1, 1), 1)));
            context.register(DRYGMY_SPAWN, BiomeModifiers.AddSpawnsBiomeModifier.singleSpawn(OVERWORLD_TAG, new net.minecraft.util.random.Weighted<>(new MobSpawnSettings.SpawnerData(ModEntities.ENTITY_DRYGMY.get(), 1, 2), 3)));
            context.register(WHIRLISPRIG_SPAWN, BiomeModifiers.AddSpawnsBiomeModifier.singleSpawn(OVERWORLD_TAG, new net.minecraft.util.random.Weighted<>(new MobSpawnSettings.SpawnerData(ModEntities.WHIRLISPRIG_TYPE.get(), 1, 2), 5)));
            ...
            context.register(ALARKINOS_SPAWN, BiomeModifiers.AddSpawnsBiomeModifier.singleSpawn(BEACH_TAG, new net.minecraft.util.random.Weighted<>(new MobSpawnSettings.SpawnerData(ModEntities.ALAKARKINOS_TYPE.get(), 1, 1), 5)));
        }
