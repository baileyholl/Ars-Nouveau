...
public class BlockStatesDatagen extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        horizontalBlock(BlockRegistry.STARBUNCLE_PLUSH.get(), getUncheckedModel(LibBlockNames.STARBUNCLE_PLUSH));
        ...
        registerOnlyState(BlockRegistry.DECOR_BLOSSOM.get(), LibBlockNames.DECOR_BLOSSOM);
        for (String s : LibBlockNames.DECORATIVE_SOURCESTONE) {
