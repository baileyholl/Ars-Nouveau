...
public class DispelEntityProvider extends SimpleDataProvider{
    ...
    protected void addEntries() {
        recipes.add(new DispelEntityRecipe(new ResourceLocation(ArsNouveau.MODID, "blaze_powder"), EntityType.BLAZE, new ItemStack(Items.BLAZE_POWDER), new LootItemCondition[]{
