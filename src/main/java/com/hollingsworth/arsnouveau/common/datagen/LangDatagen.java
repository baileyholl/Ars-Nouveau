...
public class LangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_nouveau.page1.learning_glyphs", "New Glyphs may be created through the Scribe’s Table from certain items and paying EXP. Once crafted, the Glyph can be consumed to learn it, making it available during spellcrafting. Players can share their current Glyph knowledge with each other by crafting an Annotated Codex.\n\nSee the Related Entry for the Scribe’s Table to get started.");
        ...
        add("ars_nouveau.page.magical_crafting", "8 - Magical Crafting");
        ...
        add("ars_nouveau.page2.magical_crafting", "essentials such as Magebloom Seeds, magical equipment, and charms to summon magical helpers. It can also directly enchant your gear with enchants of your choice.\n\nThe Alteration Table allows for slotting in various Threads into magical armor that grant special properties while worn.");

        add("ars_nouveau.page.source", "9 - Source");
