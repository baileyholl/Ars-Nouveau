...
public class LangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_nouveau.page2.introduction_to_spellcrafting", "shown by the bookmarks on the right side of the book. Clicking one will swap the spell you are working on.\n\nTo cast a spell, select your Spell Book on the inventory bar and right-click.\n\nPress [X] to swap to your next spell and [Z] to swap your previous spell. Press [V] to open a radial menu allowing quick selection of spells on the book. Each spell may also be hotkeyed via the Key Bind menu.");
        add("ars_nouveau.page.spell_mana", "4 - Mana");
        add("ars_nouveau.page1.spell_mana", "Casting a spell consumes your Mana based on the total cost of all the Glyphs that make up the spell. Your current Mana stores can be seen on the bar in the bottom left corner of your screen. Expended Mana will regenerate over time. Mana may also be consumed or reserved by other things such as magical items or familiars.");
