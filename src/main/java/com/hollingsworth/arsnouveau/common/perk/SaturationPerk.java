...
public class SaturationPerk extends Perk {
    ...
    public @NotNull ItemAttributeModifiers applyAttributeModifiers(ItemAttributeModifiers modifiers, ItemStack stack, int slotValue) {
        ...
        return modifiers.withModifierAdded(PerkAttributes.WHIRLIESPRIG, new AttributeModifier(INSTANCE.getRegistryName(), val, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL), EquipmentSlotGroup.ARMOR);
