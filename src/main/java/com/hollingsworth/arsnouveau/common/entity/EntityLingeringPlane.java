...
public class EntityLingeringPlane extends EntityProjectileSpell {
    ...
    public EntityLingeringPlane(EntityType<? extends EntityProjectileSpell> type, Level worldIn) {
        super(ModEntities.LINGER_SPELL.get(), worldIn);
    }

    public EntityLingeringPlane(Level worldIn, double x, double y, double z) {
        super(ModEntities.LINGER_SPELL.get(), worldIn, x, y, z);
    }

    public EntityLingeringPlane(Level worldIn, LivingEntity shooter) {
    ...
    public EntityLingeringPlane(PlayMessages.SpawnEntity packet, Level world) {
