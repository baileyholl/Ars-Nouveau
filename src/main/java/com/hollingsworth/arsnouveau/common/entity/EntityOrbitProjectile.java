    ...
    protected void onHit(@NotNull HitResult result) {
        ...
        if (result instanceof EntityHitResult entityHitResult) {
            ...
            if (this.spellResolver != null) {
                ...
                Networking.sendToNearby(level, BlockPos.containing(result.getLocation()), new PacketANEffect(PacketANEffect.EffectType.BURST, BlockPos.containing(result.getLocation()), getParticleColor()));
                attemptRemoval();
            }
