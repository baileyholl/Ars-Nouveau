...
public class LootItemRandomChanceWithEnchantedBonusConditionMixin {
    ...
    private int ars_nouveau$lootingOnGoldSnowball(Holder<Enchantment> enchantment, LivingEntity attacker, Operation<Integer> original, @Local(argsOnly = true) LootContext context) {
