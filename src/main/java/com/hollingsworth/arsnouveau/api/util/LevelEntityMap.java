...
public class LevelEntityMap {
    ...
    public void addEntity(Level level, UUID uuid) {
        addEntity(level.dimension().identifier().toString(), uuid);
    }
    ...
    public boolean containsEntity(Level level, UUID uuid) {
        return containsEntity(level.dimension().identifier().toString(), uuid);
    }
    ...
    public void removeEntity(Level level, UUID uuid) {
        removeEntity(level.dimension().identifier().toString(), uuid);
    }
    ...
    public Set<UUID> getEntities(Level level) {
        return getEntities(level.dimension().identifier().toString());
    }
