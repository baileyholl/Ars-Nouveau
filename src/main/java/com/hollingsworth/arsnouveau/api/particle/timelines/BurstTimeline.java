...
public class BurstTimeline extends BaseTimeline<BurstTimeline>{
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BurstTimeline> STREAM_CODEC = StreamCodec.composite(TimelineEntryData.STREAM, BurstTimeline::trailEffect,
    ...
    public BurstTimeline(TimelineEntryData trailEffect, TimelineEntryData onResolvingEffect){
