...
public class PerkAttributes {
    ...
    public static final RegistryObject<Attribute> MAX_MANA_BONUS = registerAttribute("ars_nouveau.perk.percent_max_mana",(id) -> new RangedAttribute(id, 1.0d, 0.0D, 10000.0D).setSyncable(true), "69a84402-96fd-4388-955e-57dc643c5ef0");
    ...
    public static final RegistryObject<Attribute> DRYGMY = registerAttribute("ars_nouveau.perk.drygmy",(id) -> new RangedAttribute(id, 0.0D, 0.0D, 1024.0D).setSyncable(true), "eb97ec0a-e1d7-4303-9983-cd9fa8324b78");
