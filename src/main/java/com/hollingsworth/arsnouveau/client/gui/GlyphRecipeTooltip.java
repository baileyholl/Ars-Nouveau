...
//    }
//
//    private void drawBorder(int pX, int pY, int pSlotWidth, int pSlotHeight, GuiGraphics pPoseStack, int pBlitOffset) {
...
//    private void blit(GuiGraphics graphics, int pX, int pY, int pBlitOffset, GlyphRecipeTooltip.Texture pTexture) {
//        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
//        graphics.blit(TEXTURE_LOCATION, pX, pY, pBlitOffset, (float) pTexture.x, (float) pTexture.y, pTexture.w, pTexture.h, TEX_SIZE, TEX_SIZE);
//    }
