...
public class GuiManaHUD {
    ...
    public static void renderOverlay(ForgeGui gui, GuiGraphics guiGraphics, float pt, int width,
        ...
        guiGraphics.blit(ms, offsetLeft, yOffset - 18, 0, 0, 108, 18, 256, 256);
        ...
        guiGraphics.blit(ms, offsetLeft + 9, yOffset - 9, 0, manaOffset, manaLength, 6, 256, 256);
        ...
        if (ArsNouveauAPI.ENABLE_DEBUG_NUMBERS) {
            ...
            guiGraphics.drawString(ms, minecraft.font, text, offset, yOffset - 10, 0xFFFFFF);
            guiGraphics.drawString(ms, minecraft.font, String.valueOf((int)(ClientInfo.reservedOverlayMana * maxMana)), offset + 69, yOffset - 20, 0xFFFFFF);
        }

        RenderSystem.setShaderTexture(0, new ResourceLocation(ArsNouveau.MODID, "textures/gui/manabar_gui_border.png"));
        guiGraphics.blit(ms, offsetLeft, yOffset - 17, 0, 18, 108, 20, 256, 256);
    }
