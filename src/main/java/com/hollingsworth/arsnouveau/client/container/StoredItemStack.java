...
//		tag.getCompoundOrEmpty(ITEMSTACK_NAME).remove("Count");
//		return tag;
//	}
//
...
//		tag.getCompoundOrEmpty(ITEMSTACK_NAME).putByte("Count", (byte) 1);
//		StoredItemStack stack = new StoredItemStack(!cheat.isEmpty() ? cheat : ItemStack.of(tag.getCompoundOrEmpty(ITEMSTACK_NAME)), !cheat.isEmpty() ? cheat.getCount() : tag.getLong(ITEM_COUNT_NAME));
