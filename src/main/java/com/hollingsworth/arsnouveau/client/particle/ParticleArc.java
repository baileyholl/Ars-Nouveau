...
//    Vector3d currentTargetPoint;
//    Vector3d sourcePoint;
//    boolean hadTarget = false;
//    boolean hadSource = false;
//    private ParticleArc(World worldIn, Vector3d coord, IAnimatedSprite sprite, Vector3d sourcePoint, Vector3d targetPoint) {
...
//                return;
//            }
//            targetPoint = new Vector3d(targetEntity.getPosX(), targetEntity.getPosY() + targetEntity.getEyeHeight() - (targetEntity.getHeight() * 0.2f), targetEntity.getPosZ());
//            currentTargetPoint = new Vector3d(targetPoint.x, targetPoint.y, targetPoint.z);
//        }else if (hadTarget){
//            this.setExpired();
//            return;
//        }
...
//                return;
//            }
//            sourcePoint = new Vector3d(sourceEntity.getPosX(), sourceEntity.getPosY() + sourceEntity.getEyeHeight() - (sourceEntity.getHeight() * 0.2f), sourceEntity.getPosZ());
//        }else if (hadSource){
//            this.setExpired();
//            return;
//        }
...
//
//
//    public static IParticleData createData(Vector3d source, Vector3d target){
//        return null;
...
//            return new ParticleArc(worldIn, new Vector3d(x, y, z), this.spriteSet, data.source, data.target);
//        }
//    }
//}
