...
public class ParticleSparkle extends SpriteTexturedParticle {
    ...
    protected ParticleSparkle(World worldIn, double x, double y, double z, double vx, double vy, double vz, float r, float g, float b, float scale, int lifetime, IAnimatedSprite sprite) {
