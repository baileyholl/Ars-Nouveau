    ...
    public static GenericItemBlockRenderer getISTER() {
        return new GenericItemBlockRenderer(model) {
            ...
            public void render(AnimBlockItem animatable, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, ItemStack stack) {
                ...
                int fillLevel = (currentItemStack.getTag() == null || currentItemStack.getTag().get("BlockEntityTag") == null) ? 0 : (currentItemStack.getTag().getCompound("BlockEntityTag").getInt("fillLevel"));
