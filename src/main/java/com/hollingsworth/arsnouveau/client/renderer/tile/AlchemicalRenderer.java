...
public class AlchemicalRenderer extends GeoBlockRenderer<AlchemicalSourcelinkTile> {
    ...
    @Override
    public void renderLate(AlchemicalSourcelinkTile animatable, PoseStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
