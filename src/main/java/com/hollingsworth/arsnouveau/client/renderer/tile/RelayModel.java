...
public class RelayModel extends Model {
    ...
    public RelayModel() {
        ...
        ring_outer.setTextureOffset(8, 18).addBox(-5.0F, -1.0F, -5.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        ring_outer.setTextureOffset(4, 18).addBox(-5.0F, -1.0F, 4.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        ring_outer.setTextureOffset(16, 16).addBox(4.0F, -1.0F, 4.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
        ring_outer.setTextureOffset(0, 17).addBox(4.0F, -1.0F, -5.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
