...
public class CarbuncleHeldItemLayer extends GeoLayerRenderer<EntityCarbuncle> {
    ...
    @Override
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer iRenderTypeBuffer, int i, EntityCarbuncle entityCarbuncle, float v, float v1, float v2, float v3, float v4, float v5) {
