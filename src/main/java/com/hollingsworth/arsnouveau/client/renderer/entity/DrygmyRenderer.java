...
public class DrygmyRenderer  extends GeoEntityRenderer<DrygmyEntity> {
    ...
    @Override
    public RenderType getRenderType(DrygmyEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
