...
public class EnchantingApparatusModel extends Model {
    public ModelPart frame_all;
    private ModelPart cap_top;
    public ModelPart cap_bot;
    public ModelPart frame_top;
    private ModelPart frame_top1;
    private ModelPart frame_top2;
    private ModelPart frame_top3;
    private ModelPart frame_top4;
    public ModelPart frame_bot;
    private ModelPart frame_bot1;
    private ModelPart frame_bot2;
    private ModelPart frame_bot3;
    private ModelPart frame_bot4;
