...
public class ItemsRegistry {
    ...
    public static RegistryWrapper<ModItem> ALCHEMISTS_CROWN = register(LibItemNames.ALCHEMISTS_CROWN, () -> new AlchemistsCrown().withTooltip("tooltip.ars_nouveau.alchemists_crown"));
