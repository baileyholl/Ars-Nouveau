   ...
   // @ObjectHolder(LibBlockNames.ARCHWOOD_SIGN) public static WallSignBlock ARCHWOOD_SIGN;
    ...
    public static class RegistryEvents {
        ...
        public static void onBlocksRegistry(final RegistryEvent.Register<Block> blockRegistryEvent) {
            ...
            registry.register(new TickableModBlock(LibBlockNames.ARCANE_BRICKS));
            ...
            registry.register(new TickableModBlock(LibBlockNames.AB_ALTERNATE));
            registry.register(new TickableModBlock(LibBlockNames.ARCANE_STONE));
            registry.register(new TickableModBlock(LibBlockNames.AB_BASKET));
            registry.register(new TickableModBlock(LibBlockNames.AB_HERRING));
            registry.register(new TickableModBlock(LibBlockNames.AB_MOSAIC));
            ...
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_SLAB));
            registry.register(new TickableModBlock(LibBlockNames.AB_CLOVER));
            ...
            registry.register(new TickableModBlock(LOG_PROP, LibBlockNames.ARCHWOOD_PLANK));
    ...
    //        registry.register(new WallSignBlock(AbstractBlock.Properties.create(Material.WOOD, JUNGLE_LOG.getMaterialColor()).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(JUNGLE_SIGN), WoodType.ACACIA).setRegistryName(LibBlockNames.ARCHWOOD_SIGN));
            registry.register(new TickableModBlock(TickableModBlock.defaultProperties().noOcclusion().lightLevel((s) -> 6),LibBlockNames.MANA_GEM_BLOCK));
            ...
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_BASKET));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_CLOVER));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_HERRING));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_MOSAIC));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_ALTERNATING));
            registry.register(new TickableModBlock(LibBlockNames.AB_SMOOTH_ASHLAR));

            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_ALT));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_ASHLAR));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_BASKET));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_CLOVER));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_HERRING));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_MOSAIC));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_SLAB));
            registry.register(new TickableModBlock(LibBlockNames.AS_GOLD_STONE));
